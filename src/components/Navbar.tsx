...
import { ShoppingBag, Flame, Menu, X, Sun, Moon, Calendar, Utensils } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 w-full glass-panel border-b transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          ...
          <a href="#contact" onClick={onOpenHomePage} className="text-xs font-bold text-heading hover:text-amber-600 uppercase tracking-wider py-1">
            Contact
          </a>
        </nav>
